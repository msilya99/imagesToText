...
extension UserDefaults.Key {
    static var isNewImagesUploaded: UserDefaults.Key<Bool> {
        return .init(name: "isNewImagesUploaded")
    }

    static var isContentExist: UserDefaults.Key<Bool> {
        return .init(name: "isContentExist")
    }
}
